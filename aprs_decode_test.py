...
# Generated: Thu Dec 20 21:44:46 2018
##################################################
...
class aprs_decode_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'aprs_bytes.txt', False)
        ...
        self.connect((self.blocks_char_to_float_0, 0), (self.qtgui_time_sink_x_1, 1))    
